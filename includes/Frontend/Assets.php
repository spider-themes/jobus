...
class Assets {
    ...
    public static function enqueue_scripts(): void
    {
	    ...
	    // Register Style's
	    wp_register_style('lightbox', JOBUS_VEND . '/lightbox/lightbox.min.css', [], JOBUS_VERSION );


        // Enqueue Style's
        wp_enqueue_style( 'bootstrap', JOBUS_VEND . '/bootstrap/bootstrap.min.css', [], '5.1.3' );
        wp_enqueue_style( 'nice-select', JOBUS_VEND . '/nice-select/nice-select.css', [], JOBUS_VERSION );
        wp_enqueue_style( 'bootstrap-icons', JOBUS_VEND . '/bootstrap-icons/font.css', [], JOBUS_VERSION );
        wp_enqueue_style( 'slick', JOBUS_VEND . '/slick/slick.css', [], JOBUS_VERSION );
        wp_enqueue_style( 'slick-theme', JOBUS_VEND . '/slick/slick-theme.css', [], JOBUS_VERSION );
        ...
        // Register Scripts
        wp_register_script( 'isotope', JOBUS_VEND . '/isotope/isotope.pkgd.min.js', [ 'jquery' ], '3.0.6', true );
        wp_register_script( 'lightbox', JOBUS_VEND . '/lightbox/lightbox.min.js', [ 'jquery' ], '2.11.4', true );

        // Load Script and Ajax Process
        wp_register_script( 'jobus-job-application-form', JOBUS_JS . '/job-application-form.js', [ 'jquery' ], JOBUS_VERSION, true );
        ...
        // Enqueue Scripts
        wp_enqueue_script( 'nice-select', JOBUS_VEND . '/nice-select/jquery.nice-select.min.js', [ 'jquery' ], '1.0', true );
        wp_enqueue_script( 'bootstrap', JOBUS_VEND . '/bootstrap/bootstrap.min.js', [ 'jquery' ], '5.1.3', true );
