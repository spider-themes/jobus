...
?>
<div class="card-wrapper-three jbs-row">
	<?php
	if ( is_array( $categories ) ) {
		...
		foreach ( $categories as $index => $category ) {
            ...
            <div class="jbs-col-lg-<?php echo esc_attr( $column ); ?> jbs-col-md-4 jbs-col-sm-6 jbs-d-flex">
                <div class="card-style-four tran3s jbs-w-100 wow fadeInUp" data-wow-delay="<?php echo esc_attr( $delay_time ) ?>s">
                    <a href="<?php echo esc_url( get_term_link( $category ) ) ?>" class="d-block">
						...
						<?php } ?>
                        <div class="title tran3s fw-500 jbs-text-lg">
	...
	if ( ! empty( $settings['view_all_btn_url'] ) ) {
        ...
        <div class="jbs-col-lg-3 jbs-col-md-4 jbs-col-sm-6 jbs-d-flex">
            <div class="card-style-four bg-color tran3s jbs-w-100 wow fadeInUp" data-wow-delay="0.1s">
                <a <?php jobus_button_link( $settings['view_all_btn_url'] ) ?> class="d-block">
                    ...
                    <div class="jbs-d-flex jbs-align-items-center jbs-justify-content-end mt-50">
