...
<div class="jbs-job-listing-widget">
    <div class="jbs-job-listing-wrapper jbs-border-wrapper wow fadeInUp">
        <?php
        while ($posts->have_posts()) : $posts->the_post();
            ...
            ?>
            <div class="jbs-job-list-one jbs-position-relative jbs-bottom-border">
                <div class="jbs-row jbs-justify-content-between jbs-align-items-center jbs-job_specifications_area">
                    <div class="jbs-jod_list_title_area">
                        <div class="job-title jbs-d-flex jbs-align-items-center">
                            <a href="<?php the_permalink(); ?>" class="logo">
                                <?php the_post_thumbnail('full', [ 'class' => 'lazy-img jbs-m-auto' ]); ?>
                            </a>
                            <a href="<?php the_permalink(); ?>">
                                <?php the_title('<h3 class="title jbs-fw-500 jbs-tran3s">', '</h3>') ?>
                            </a>
                        </div>
                    </div>

                    <div class="jbs-jod_list_meta_area">
                    ...
                    <div class="jbs-jod_list_cat_area">
                    ...
                    <div class="jbs-jod_list_btn_area">
