        ...
        while ( $posts->have_posts() ) : $posts->the_post();
            ...
            <div class="jbs-col-lg-3 jbs-col-sm-6">
                <div class="card-style-ten jbs-text-center tran3s wow fadeInUp">
                    ...
                    <div class="jbs-text-lg jbs-fw-500 jbs-text-dark jbs-mt-15 jbs-mb-30"><?php the_title() ?></div>
                    <?php if ( !empty( $company_attr_meta_1 ) ) : ?>
                        <p class="jbs-mb-20 jbs-text-capitalize"><?php echo esc_html($company_attr_meta_1) ?></p>
                    <?php endif; ?>
                    <a href="<?php echo esc_url(jobus_get_selected_company_count(get_the_ID())); ?>" class="open-job-btn jbs-fw-500 tran3s">
                        <?php
