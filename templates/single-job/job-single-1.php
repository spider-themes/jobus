                ...
                <div class="details-post-data jbs-me-xxl-5 jbs-pe-xxl-4">
                    <div class="job-head">
                        <div class="post-date">
                            ...
                            <a href="<?php echo esc_url($company_url) ?>" class="jbs-fw-500 jbs-text-dark"> <?php echo esc_html($company_name); ?> </a>
                        </div>
                        <?php the_title('<h1 class="post-title">', '</h1>') ?>
                        <ul class="share-buttons jbs-d-flex jbs-flex-wrap jbs-style-none">
                            <li><a class="share-item" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()); ?>" target="_blank">
                                    <i class="bi bi-facebook"></i>
                                    <span>Facebook</span>
                                </a>
                            </li>
                            <li><a class="share-item" href="https://twitter.com/intent/tweet?url=<?php echo urlencode(get_permalink()); ?>&text=<?php echo urlencode(get_the_title()); ?>" target="_blank">
                                    <i class="bi bi-twitter"></i>
                                    <span>Twitter</span>
                                </a>
                            </li>
                            <li><button type="button" class="share-item share-copy-btn" data-copy-url="<?php echo esc_url(get_permalink()); ?>">
                    ...
                    <div class="jbs-border-top jbs-mt-40 jbs-pt-40">
                        ...
                        if ( is_user_logged_in() ) {
                            ...
                            if ( ! empty( $meta['is_apply_btn'] ) && $meta['is_apply_btn'] == 'custom' && ! empty( $meta['apply_form_url'] ) ) { ?>
                                ...
                                <a href="#" class="btn-one jbs-w-100 jbs-mt-25" data-jbs-toggle="modal" data-jbs-target="#applyJobModal">
                                    <?php esc_html_e( 'Apply Now', 'jobus' ); ?>
                                </a>
                                <?php
                            }
