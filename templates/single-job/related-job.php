    ...
    <div class="container">
        <div class="position-relative">
            <div class="title-three text-center text-md-start mb-55 lg-mb-40">
                <h2 class="main-font">
                    <?php esc_html_e( 'Related Jobs', 'jobus' ); ?>
                </h2>
            </div>
                ...
                while ( $related_jobs->have_posts() ) : $related_jobs->the_post();
                    ...
                    <div class="item">
                        <div class="job-list-two style-two position-relative">
                            ...
                            <?php 
                            if ( jobus_get_meta_attributes( 'jobus_meta_options','job_related_post_meta_1' ) ) : 
                                ?>
                                <div>
                            ...
                            <?php 
                            if ( jobus_get_meta_attributes( 'jobus_meta_options','job_related_post_meta_2' ) ) : 
                                ?>
                                <div class="job-salary">
                                    <span class="fw-500 text-dark">
                                        <?php echo jobus_get_meta_attributes( 'jobus_meta_options','job_related_post_meta_2' ); ?>
                                    </span>
                                </div>
                                <?php 
                            endif; 
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-auto">
                                ...
                                <?php 
                                if ( jobus_get_meta_attributes( 'jobus_meta_options','job_related_post_meta_3' ) ) : 
                                    ?>
            ...
            <ul class="slider-arrows slick-arrow-one color-two d-flex justify-content-center style-none sm-mt-20">
                <li class="prev_e slick-arrow">
                    <i class="bi bi-arrow-left"></i>
                </li>
                <li class="next_e slick-arrow">
