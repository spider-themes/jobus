...
<section class="job-details jbs-job-details-two style-two jbs-pt-100 jbs-lg-pt-80 jbs-pb-130 jbs-lg-pb-80">
        ...
        <div class="jbs-row">
            <div class="jbs-col-xxl-9 jbs-col-xl-10 jbs-m-auto">
                <div class="details-post-data jbs-ps-xxl-4 jbs-pe-xxl-4">
                                ...
                                if ( ! empty( $meta_options[ $meta_key ] ) ) {
                                    ...
                                    <div class="bg-wrapper jbs-bg-white jbs-text-center">
                                        ...
                                        if ( $field['is_meta_icon'] == 'meta_icon' && ! empty( $field['meta_icon'] ) ) {
                                            ...
                                            echo wp_get_attachment_image( $field['meta_image']['id'], 'full', false,
                                                    [ 'class' => 'lazy-img jbs-m-auto icon' ] );
                                        }
                    ...
                    echo '<div class="jbs-job-content">';
                    the_content();
                    echo '</div>';
