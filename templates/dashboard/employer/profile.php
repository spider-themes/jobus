...
<div class="jbs-position-relative">
    ...
    <h2 class="jbs-main-title jbs-mb-0"> <?php esc_html_e( 'Profile', 'jobus' ); ?> </h2>
        <!-- View My Profile -->
    ...
    <form action="#" id="company-profile-form" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="jbs-bg-white jbs-card-box jbs-border-20">
            ...
            <div class="jbs-user-avatar-setting jbs-d-flex jbs-align-items-center jbs-mb-30" id="employer-profile">
                <img src="<?php echo esc_url( $avatar_url ); ?>" alt="<?php echo esc_attr( $user->display_name ); ?>" class="lazy-img jbs-user-img"
                     id="company-avatar-preview">
                <button type="button" class="jbs-upload-btn jbs-position-relative jbs-tran3s jbs-ms-4 jbs-me-3 jbs-border-0" id="company-profile-picture-upload">
                    <?php esc_html_e( 'Upload new photo', 'jobus' ); ?>
                </button>
                <button type="button" name="company_delete_profile_picture" class="jbs-delete-btn jbs-tran3s" id="company-delete-profile-picture">
            ...
            <div class="jbs-dash-input-wrapper">
                ...
                <div class="editor-wrapper">
                    ...
                    if ( $show_rich_editor ) {
                        ...
                        echo '<textarea name="company_description" id="company_description" rows="8" class="jbs-form-control jbs-size-lg">' . esc_textarea( $description ) . '</textarea>';
                    }
                    ?>
                </div>
                <div class="jbs-alert-text">
                    <?php esc_html_e( 'Brief description for your profile. URLs are hyperlinked.', 'jobus' ); ?>
                </div>
            </div>
        </div>

        <div class="jbs-bg-white jbs-card-box jbs-border-20 jbs-mt-40" id="job-taxonomy">
            ...
            <div class="jbs-dash-input-wrapper jbs-mb-40 jbs-mt-20">
                ...
                <div class="jbs-skills-wrapper">
                    ...
                    ?>
                    <ul id="company-category-list" class="jbs-style-none jbs-d-flex jbs-flex-wrap jbs-align-items-center">
            ...
            <div class="jbs-dash-input-wrapper jbs-mb-40 jbs-mt-20">
                ...
                <div class="jbs-skills-wrapper">
                    ...
                    ?>
                    <ul id="company-location-list" class="jbs-style-none jbs-d-flex jbs-flex-wrap jbs-align-items-center">
        ...
        <div class="jbs-bg-white jbs-card-box jbs-border-20 jbs-mt-40" id="company-specifications">
        ...
        <div class="jbs-bg-white jbs-card-box jbs-border-20 jbs-mt-40">
            <h4 class="jbs-dash-title-three"><?php esc_html_e( 'Company Website', 'jobus' ); ?></h4>
            <div class="jbs-row">
        ...
        <div class="jbs-bg-white jbs-card-box jbs-border-20 jbs-mt-40" id="company-social-icons">
            <h4 class="jbs-dash-title-three">
            ...
            ?>
            <div class="jbs-accordion jbs-dash-accordion-one" id="social-links-repeater">
                <?php foreach ( $user_social_links as $index => $item ) :
                    ...
                    <div class="jbs-accordion-item social-link-item">
                        ...
                        <div id="<?php echo esc_attr( $social_icon_id ); ?>" class="jbs-accordion-collapse jbs-collapse"
            ...
            <button href="javascript:void(0)" class="jbs-dash-btn-one jbs-mt-2" id="add-social-link">
        ...
        <div class="jbs-bg-white jbs-card-box jbs-border-20 jbs-mt-40" id="company-video">
            ...
            <div class="intro-video-form jbs-position-relative jbs-mt-20 jbs-w-100">
                ...
                <div class="jbs-dash-input-wrapper jbs-mb-15">
                    ...
                    <div id="company-bg-img-preview" class="jbs-preview jbs-bg-img-preview <?php echo empty( $video_data['company_video_bg_img']['url'] ) ? 'hidden' : ''; ?>">
                        <div class="jbs-attached-file jbs-d-flex jbs-align-items-center jbs-justify-content-between">
                            ...
                            <a href="#" id="company-remove-uploaded-bg-img" class="jbs-remove-btn"><i class="bi bi-x"></i></a>
                        </div>
                    </div>
        ...
        <div class="jbs-bg-white jbs-card-box jbs-border-20 jbs-mt-40" id="company-testimonials">
            <h4 class="jbs-dash-title-three"><?php esc_html_e( 'Testimonials', 'jobus' ); ?></h4>
            <div class="jbs-dash-input-wrapper jbs-mb-15">
            ...
            <div class="jbs-accordion jbs-dash-accordion-one" id="company-testimonial-repeater">
                <?php
                ...
                foreach ( $testimonials as $key => $testimonial ) {
                    ...
                    <div class="jbs-accordion-item company-testimonial-item">
                        ...
                        <div id="<?php echo esc_attr( $testimonial_id ); ?>" class="jbs-accordion-collapse jbs-collapse"
                                    ...
                                    <div class="jbs-col-lg-10">
                                        <div class="jbs-dash-input-wrapper jbs-mb-10">
                                            ...
                                            <input type="hidden" name="company_testimonials[<?php echo esc_attr( $key ); ?>][image]"
                                                   id="company-testimonial-<?php echo esc_attr( $key ); ?>-image" class="jbs-testimonial-image-data"
                                            ...
                                            <div class="jbs-testimonial-image-preview jbs-mt-2 jbs-mb-2" id="testimonial-image-preview-<?php echo esc_attr( $key ); ?>">
                                                <?php
            ...
            <button href="javascript:void(0)" class="jbs-dash-btn-one jbs-mt-2" id="add-company-testimonial">
        ...
        <div class="button-group jbs-d-inline-flex jbs-align-items-center jbs-mt-30">
            <button type="submit" class="jbs-dash-btn-two jbs-tran3s jbs-me-3 jbs-rounded-3"><?php echo esc_html( $save_changes_label ); ?></button>
        </div>
