...
<div class="jbs-position-relative">
    ...
    <form action="" id="candidate-profile-form" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="jbs-bg-white card-box border-20" id="candidate-profile-description">
            <div class="user-avatar-setting jbs-d-flex jbs-align-items-centerjbs-mb-30">
                        ...
                        <div id="specifications-repeater">
                            ...
                            if (!empty($candidate_specifications)) {
                                foreach ($candidate_specifications as $i => $spec) {
                                    ?>
                                    <div class="dash-input-wrapper jbs-mb-20 specification-item jbs-d-flex jbs-align-items-center jbs-gap-2">
