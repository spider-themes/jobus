...
<div class="jbs-position-relative">
    <h2 class="jbs-main-title"><?php esc_html_e('My Profile', 'jobus'); ?></h2>
    ...
    <form action="" id="candidate-profile-form" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="jbs-bg-white jbs-card-box jbs-border-20" id="candidate-profile-description">
            <?php if ( $show_profile_photo ) : ?>
            <div class="jbs-user-avatar-setting jbs-d-flex jbs-align-items-center jbs-mb-30">
                <img src="<?php echo esc_url( $avatar_url ); ?>" alt="<?php echo esc_attr( $user->display_name ); ?>" class="lazy-img jbs-user-img" id="candidate_avatar">
                <div class="jbs-upload-btn jbs-position-relative jbs-tran3s jbs-ms-4 jbs-me-3 jbs-border-0 jbs-upload_btn-width" id="candidate_profile_picture_upload">
                ...
                <button type="button" name="delete_profile_picture" class="jbs-delete-btn jbs-tran3s" id="delete_profile_picture">
            ...
            <div class="jbs-dash-input-wrapper">
                ...
                <div class="editor-wrapper">
                    ...
                    if ( $show_rich_editor ) {
                        ...
                        echo '<textarea name="candidate_description" id="candidate_description" rows="8" class="jbs-form-control jbs-size-lg">' . esc_textarea( $description ) . '</textarea>';
                    }
                    ?>
                </div>
        ...
        <div class="jbs-bg-white jbs-card-box jbs-border-20 jbs-mt-40" id="candidate-profile-social-icons">
            ...
            <button type="button" class="jbs-dash-btn-one jbs-mt-2" id="add-social-link">
        ...
        <div class="jbs-bg-white jbs-card-box jbs-border-20 jbs-mt-40" id="candidate-profile-specifications">
            <h4 class="jbs-dash-title-three"><?php esc_html_e('Specifications', 'jobus'); ?></h4>
            <div class="jbs-row">
                <div class="jbs-col-lg-3">
                    <div class="jbs-dash-input-wrapper jbs-mb-25">
            ...
            <div class="jbs-row">
                <div class="jbs-col-12">
                    <div class="jbs-dash-input-wrapper jbs-mb-25">
                        ...
                        <div id="jbs-specifications-repeater">
                            <?php
                            if (!empty($candidate_specifications)) {
                                foreach ($candidate_specifications as $i => $spec) {
                                    ?>
                                    <div class="jbs-dash-input-wrapper jbs-mb-20 jbs-specification-item jbs-d-flex jbs-align-items-center jbs-gap-2">
                        ...
                        <button type="button" class="jbs-dash-btn-one" id="jbs-add-specification">
        ...
        <div class="jbs-bg-white jbs-card-box jbs-border-20 jbs-mt-40" id="candidate-profile-map">
            <h4 class="jbs-dash-title-three"><?php esc_html_e('Address & Location', 'jobus'); ?></h4>
            <div class="jbs-row">
                <div class="jbs-col-12">
                    <div class="jbs-dash-input-wrapper jbs-mb-25">
                        ...
                        ?>
                        <div class="jbs-map-frame jbs-mt-30">
