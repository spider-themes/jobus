...
$empty_title = jobus_opt( 'empty_applied_jobs_title', esc_html__( 'No Applied Jobs', 'jobus' ) );
$empty_desc = jobus_opt( 'empty_applied_jobs_desc', esc_html__( 'You haven\'t applied for any jobs yet.', 'jobus' ) );
