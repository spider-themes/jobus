...
<div class="jbs-modal popUpModal login_from fade" id="filterPopUp" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="pt-25 pb-30 jbs-ps-4 jbs-pe-4">
                            ...
                            <div class="jbs-row">
                                <div class="jbs-col-xl-2 jbs-m-auto">
                                    <button type="submit"
                                        class="jbs-btn-ten fw-500 jbs-text-white jbs-w-100 jbs-text-center tran3s">
