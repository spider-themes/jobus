            ...
            <div class="col-12">
                <div class="position-relative">
                    ...
                    <div class="upper-filter d-flex justify-content-between align-items-start align-items-md-center mb-20">
                        <div class="d-md-flex justify-content-between align-items-center">
                            ...
                            <div class="total-job-found md-mt-10">
                                ...
                                <span class="fw-500">
                                    <?php echo esc_html( $candidate_query->found_posts ); ?>
                                </span>
                                <?php
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="short-filter d-flex align-items-center">
                                ...
                                <div class="text-dark fw-500 me-2">
                                    <?php esc_html_e( 'Short By:', 'jobus' ); ?>
                                </div>
                                        ...
                                        <div class="candidate-profile-card<?php echo esc_attr( $is_favourite ); ?> text-center grid-layout border-0 mb-25">
                                            ...
                                            if ( jobus_get_meta_attributes( 'jobus_meta_candidate_options', 'candidate_archive_meta_1' ) ) :
                                                ...
                                                <div class="candidate-post text-capitalize">
                                                    <?php echo jobus_get_meta_attributes( 'jobus_meta_candidate_options', 'candidate_archive_meta_1' ); ?>
                                                </div>
                                                <?php
                                            endif;
                                                ...
                                                if ( jobus_get_meta_attributes( 'jobus_meta_candidate_options', 'candidate_archive_meta_2' ) ) :
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="candidate-info mt-10">
                                                            <span>
                                                                <?php echo esc_html( jobus_meta_candidate_spec_name(2) ); ?>
                                                            </span>

                                                            <div class="text-capitalize">
                                                                <?php echo jobus_get_meta_attributes( 'jobus_meta_candidate_options', 'candidate_archive_meta_2' ); ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <?php
                    ...
                    <div class="pt-20 d-sm-flex align-items-center justify-content-between">
                        <?php 
                        jobus_showing_post_result_count( $candidate_query);
                        jobus_pagination( $candidate_query, 'jobus_pagination_two', '<i class="bi bi-chevron-left"></i>', '<i class="bi bi-chevron-right"></i>' ); 
                        ?>
                    </div>
                </div>
            </div>
