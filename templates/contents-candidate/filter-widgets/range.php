<?php
/**
 * Range slider filter widget for candidate specifications.
 *
 * This template can be overridden by copying it to yourtheme/jobus/contents-candidate/filter-widgets/range.php.
 *
