...
<section class="jbs-candidates-profile-2 jbs-bg-color jbs-pt-180 jbs-lg-pt-70 jbs-pb-130 jbs-lg-pb-80">
    <div class="jbs-container">
        <div class="jbs-row">
            <div class="jbs-col-xxl-9 jbs-col-lg-8">
                <div class="jbs-candidates-profile-details-2 jbs-me-xxl-5 jbs-pe-xxl-4">
                    <?php
                    ...
                    if ( ! empty( $meta['video_url'] ) ) {
                        if ( ! empty( $meta['video_title'] ) ) { ?>
                            <h3 class="jbs-title"><?php echo esc_html( $meta['video_title'] ) ?></h3>
                            <?php
                        }
                        ?>
                    ...
                    if ( $educations ) {
                        ?>
                        <div class="jbs-inner-card jbs-border-style jbs-mb-75 jbs-lg-mb-50">
                            <?php
                            if ( ! empty( $meta['education_title'] ) ) { ?>
                                <h3 class="jbs-title"><?php echo esc_html( $meta['education_title'] ) ?></h3>
                                <?php
                            }
                            ?>
                            <div class="jbs-time-line-data jbs-position-relative jbs-pt-15">
                                <?php
                                foreach ( $educations as $item ) {
                                    ?>
                                    <div class="jbs-info jbs-position-relative">
                                        <?php
                                        if ( ! empty( $item['sl_num'] ) ) { ?>
                                            <div class="jbs-numb jbs-fw-500 jbs-rounded-circle jbs-d-flex jbs-align-items-center jbs-justify-content-center"><?php echo esc_html( $item['sl_num'] ) ?></div>
                                            <?php
                                        }
                                        if ( ! empty( $item['title'] ) ) { ?>
                                            <div class="jbs-text_1 jbs-fw-500"><?php echo esc_html( $item['title'] ) ?></div>
                                            <?php
                                        }
                    ...
                    if ( is_array( $skills ) ) {
                        ?>
                        <div class="jbs-inner-card jbs-border-style jbs-mb-75 jbs-lg-mb-50">
                            <h3 class="jbs-title"><?php esc_html_e( 'Skills', 'jobus' ) ?></h3>
                            <ul class="jbs-style-none jbs-skill-tags jbs-d-flex jbs-flex-wrap jbs-pb-25">
                                <?php
                    ...
                    if ( $experience ) {
                        ?>
                        <div class="jbs-inner-card jbs-border-style jbs-mb-60 jbs-lg-mb-50">
                            <?php
                            if ( ! empty( $meta['experience_title'] ) ) { ?>
                                <h3 class="jbs-title"><?php echo esc_html( $meta['experience_title'] ) ?></h3>
                                <?php
                            }
                            ?>
                            <div class="jbs-time-line-data jbs-position-relative jbs-pt-15">
                                ...
                                foreach ( $experience as $item ) {
                                    ...
                                    <div class="jbs-info jbs-position-relative">
                                        ...
                                        if ( ! empty( $item['start_date'] ) ) { ?>
                                            <div class="jbs-text_1 jbs-fw-500"><?php echo esc_html( $item['start_date'] ) ?>
...
?>
                    <div class="jbs-inner-card">
                    <?php
                    if ( $portfolio_ids ) {
                        if ( ! empty( $meta['portfolio_title'] ) ) { ?>
                            <h3 class="jbs-title"><?php echo esc_html( $meta['portfolio_title'] ) ?></h3>
                            <?php
                        }
                        ?>
                        <div class="jbs-candidate-portfolio-slider" data-rtl="<?php echo esc_attr( jobus_rtl() ) ?>">
                            <?php
                            foreach ( $portfolio_ids as $item ) {
                                $image_url = wp_get_attachment_image_url( $item, 'full' )
                                ?>
                                <div class="jbs-item">
                                    <a href="<?php echo esc_url( $image_url ) ?> " class="jbs-example-image-link jbs-w-100 jbs-d-block"
            ...
            <div class="jbs-col-xxl-3 jbs-col-lg-4">
                <div class="jbs-candidate-profile-2-sidebar jbs-ms-xl-5 jbs-ms-xxl-0 jbs-md-mt-60">
                    ...
                    <h4 class="jbs-sidebar-title"><?php esc_html_e( 'Email', 'jobus' ) ?><?php the_title() ?></h4>
                    <div class="jbs-email-form jbs-bg-wrapper">
                        <p><?php esc_html_e( 'Your email address & profile will be shown to the recipient.', 'jobus' ) ?></p>

                        <form action="javascript:void(0)" name="candidate_email_from" id="jbs-candidate-email-from" method="post">
                            ...
                            <div id="jbs-email-form-message" class="jbs-email-form-message"></div>
                        </form>
