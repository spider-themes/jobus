                ...
                <form action="<?php echo esc_url(get_post_type_archive_link('jobus_job')) ?>" class="jbs-pt-25 jbs-pb-30" role="search" method="get">
                    ...
                    <div class="jbs-row">
                        <div class="jbs-col-xl-2 jbs-m-auto">
                            <button type="submit" class="btn-ten jbs-fw-500 jbs-text-white jbs-w-100 jbs-text-center tran3s mt-30 jbs-md-mt-10"><?php esc_html_e('Apply Filter', 'jobus'); ?></button>
                        </div>
                    </div>
                </form>
            </div>
