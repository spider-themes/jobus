...
if (!$has_meta_widgets && !$has_taxonomy_widgets && !$show_search_form) {
    ...
    if (current_user_can('manage_options')) {
        ...
        <div class="jbs-col-xl-3 jbs-col-lg-4">
            <div
                style="padding: 15px; background-color: #fff8e5; border: 1px solid #ffe58f; border-radius: 4px; color: #663c00; margin-bottom: 20px;">
...
<div class="jbs-col-xl-3 jbs-col-lg-4">
    ...
    <div class="jbs-filter-area-tab jbs-offcanvas jbs-offcanvas-start" id="filteroffcanvas">
        ...
        <div class="jbs-d-flex jbs-justify-content-between jbs-align-items-center">
            ...
            ?>
            <a href="<?php echo esc_url(get_post_type_archive_link('jobus_job')); ?>" id="jbs-clear-all-filters"
                class="jbs-clear-all-btn jbs-fs-13 jbs-fw-500 jbs-tran3s <?php echo $has_active_filters ? '' : 'jbs-d-none'; ?>">
                <?php esc_html_e('Clear All', 'jobus'); ?>
            </a>
        </div>
        <div class="jbs-light-bg jbs-border-20 jbs-ps-4 jbs-pe-4 jbs-pt-25 jbs-pb-30 jbs-mt-20">
            <form action="<?php echo esc_url(get_post_type_archive_link('jobus_job')) ?>" role="search"
                ...
                if ($show_search_form) {
                    ...
                    <div class="jbs-filter-block jbs-bottom-line">
                        ...
                        <div class="<?php echo $is_search_collapsed ? 'jbs-collapse' : 'jbs-collapse jbs-show'; ?>"
                            ...
                            style="<?php echo !$is_search_collapsed ? 'display: block;' : ''; ?>">
                ...
                if ($has_meta_widgets) {
                    foreach ($filter_widgets as $index => $widget) {
                        ...
                        ?>
                        <div class="jbs-filter-block jbs-bottom-line">
                            <a class="jbs-filter-title jbs-fw-500 jbs-text-dark jbs-pointer<?php echo $is_collapsed ? ' jbs-collapsed' : ''; ?>"
