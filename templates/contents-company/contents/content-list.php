...
<div class="jbs-accordion-box list-style">
	...
	while ( $company_query->have_posts() ) : $company_query->the_post();
		...
		?>
        <div class="jbs-company-list-layout jbs-mb-20<?php echo esc_attr( $is_favourite . $is_popup_border_none ) ?>">
            <div class="jbs-row jbs-justify-content-between jbs-align-items-center">
                <div class="jbs-col-xl-5">
                    <div class="jbs-d-flex jbs-align-items-xl-center">
						<?php if ( has_post_thumbnail() ) : ?>
                            <a href="<?php the_permalink(); ?>" class="jbs-company-logo jbs-rounded-circle">
								<?php the_post_thumbnail( 'full', [ 'class' => 'lazy-img jbs-rounded-circle' ] ); ?>
                            </a>
						<?php endif; ?>
                        <div class="jbs-company-data">
				...
				<?php if ( jobus_get_meta_attributes( 'jobus_meta_company_options', 'company_archive_meta_1' ) ) : ?>
                    <div class="jbs-col-xl-4 jbs-col-md-8">
                        <div class="jbs-d-flex jbs-align-items-center jbs-ps-xxl-5 jbs-lg-mt-20">
                            <div class="jbs-d-flex jbs-align-items-center">
                                <div class="jbs-team-text jbs-text-capitalize">
                ...
                <div class="jbs-col-xl-3 jbs-col-md-4">
                    <div class="btn-group jbs-d-flex jbs-align-items-center jbs-justify-content-md-end jbs-lg-mt-20">
						<?php
						if ( $company_count > 0 ) { ?>
                            <a href="<?php echo esc_url( jobus_get_selected_company_count( get_the_ID() ) ); ?>"
                               class="jbs-open-job-btn jbs-text-center jbs-fw-500 jbs-tran3s jbs-me-2">
								<?php
