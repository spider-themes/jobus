<?php
/**
 * Location filter widget for the company listing
 *
 * This file is used to display the location filter widget in the company archive page.
 *
 * This template can be overridden by copying it to yourtheme/jobus/contents-company/filter-widgets/locations.php.
 *
...
if ( ! empty( $term_location ) ) {
    ...
    <ul class="style-none filter-input">
		...
		foreach ( $term_location as $key => $term ) {
